<%-- 
    Document   : cargarRecompensa
    Created on : 8/07/2016, 04:27:16 PM
    Author     : carlosrene
--%>
         ...
         <div class="text-center container">
          ...
          <div class="form-group">
              ...
              <table class="table table-striped table-bordered table-condensed">
                  		<tr>
                                    <td>nombre</td><td>descripcion</td><td>meta</td><td>tiempo</td><td>monto</td><td>recompensa</td>
                  		</tr>
              ...
              <%
                    ...
                    try {
                        ...
                        java.util.List<cooperacha.Iniciativa> result = port.consultarInicitativaporusuario(cod_usuario);
              ...
              %><tr>
                  ...
                  <td><%=nombre%></td><td><%=descripcion%></td><td><%=meta%></td><td><%=tiempo%><td><%=monto%></td><td><button class="form-control btn btn-primary" type="submit" value="<%=cod_iniciativa%>" name="<%=cod_iniciativa%>">carga masiva</button></td>
               </tr><%
                        ...
                        if(clave!=null){
                            ...
                            %><jsp:forward page="cargarRecompensaII.jsp"></jsp:forward><%
                        }
